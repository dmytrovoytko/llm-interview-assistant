...
class Index:
    ...
    def search(self, query, filter_dict={}, boost_dict={}, num_results=10, threshold=0.01):
        """
        ...
        # Filter out zero-score results / lower than threshold
        top_docs = [self.docs[i] for i in top_indices if scores[i] > threshold]
